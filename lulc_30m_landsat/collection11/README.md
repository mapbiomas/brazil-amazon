...
This workflow uses its own local `utils/` and `data/area/` directories inside `collection11/`. Keep those files alongside the scripts unless you also refactor the path handling.
