...
```sh
python3 lulc_10m_sentinel/collection-3/1-mapbiomas-sentinel-2-extract-stable-samples-1.py
python3 lulc_10m_sentinel/collection-3/2-mapbiomas-sentinel-2-extract-similarity-mask-1.py
python3 lulc_10m_sentinel/collection-3/3-mapbiomas-sentinel-2-extract-samples-1.py
python3 lulc_10m_sentinel/collection-3/4-mapbiomas-sentinel-2-classify-2.py
```
